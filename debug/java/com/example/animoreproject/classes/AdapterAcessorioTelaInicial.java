...
public class AdapterAcessorioTelaInicial extends RecyclerView.Adapter<AdapterAcessorioTelaInicial.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.btnBolsaAcessorio.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                System.out.println("BOTAO BOLSA CLICADO!");
                // TODO
            }
        });
        holder.btnInfoAcessorio.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                int position = holder.getAdapterPosition();
                if (position != RecyclerView.NO_POSITION) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ImageButton  btnBolsaAcessorio, btnInfoAcessorio;
        ...
        public ViewHolder(View view) {
            ...
            btnBolsaAcessorio = view.findViewById(R.id.btnBolsaAcessorio);
            btnInfoAcessorio  = view.findViewById(R.id.btnInfoAcessorio);
        }
    }
