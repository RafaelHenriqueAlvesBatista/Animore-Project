...
public class FormCadastro extends AppCompatActivity {
    ...
    private LinearLayout clyFormulario, llyStatusBar, llyFormulario1, llyFormulario2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        clyFormulario    = findViewById(R.id.clyFormulario);
            ...
            public void onClick(View view) {
                ...
                if (nome.isEmpty() || telefone.isEmpty() || email.isEmpty() || senha.isEmpty()){
                    ...
                    if (segundoFormulario) {
                        ...
                        Snackbar mensagem = Snackbar.make(view, R.string.message_emptyInputs2, Snackbar.LENGTH_SHORT);
                        mensagem.setBackgroundTint(Color.WHITE);
                        mensagem.setTextColor(Color.BLACK);
                        mensagem.show();
                    }
